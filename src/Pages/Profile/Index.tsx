...
import Rightflag from '../../components/iconComponents/right-flag';
import Accountinfo from '../../components/iconComponents/Account-info';
import Settingsicon from '../../components/iconComponents/Settingsicon';
import Personalinfo from '../../components/iconComponents/Personal-info';
...
const Index: React.FC = () => {
  ...
  return (
    <div className="flex flex-row-reverse h-screen overflow-hidden">
      ...
      <div>
        {profile === "PersonInformation" && <Personalinformation /> }
