        ...
        <div>
            ...
            <div className="absolute left-[1/2] -ml-0.5 w-[0.5px] border-solid h-screen bg-[#AAAAAA]"></div>
                ...
                <div className="w-[266px] h-[190px] top-[249px] gap-[32px] bg-white flex flex-col mt-[35px] " >
                    <div className="w-[266px] h-[40px] rounded pt-1 pr-2 pl-1 pb-2 gap-[11px] bg-[#C2F7FA]">
                        <div className="w-[133px] h-[32px] text-xl font-black leading-8 flex ml-[110px] text-right">اطلاعات فردی
                    ...
                    <div className="w-[266px] h-[40px] rounded pt-1 pr-2 pl-1 pb-2 gap-[11px] bg-white">
                        <div className="w-[225px] h-[35px] text-xl font-medium leading-[34.55px] flex ml-[100px] text-right">اطلاعات حساب
                    ...
                    <div className="w-[266px] h-[40px] rounded pt-1 pr-2 pl-1 pb-2 gap-[11px] bg-white">
                        <div className="w-[225px] h-[35px] text-xl font-medium leading-[34.55px] flex ml-[140px] text-right">تنظیمات
