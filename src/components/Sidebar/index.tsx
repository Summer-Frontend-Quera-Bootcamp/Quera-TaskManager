  ...
  return (
    <div className="h-screen w-[340px] border-l-2 absolute right-0">
      ...
      <div className="mt-[27px] mr-[50px] ml-[16px] ">
        <div className="flex" onClick={toggleListVisibility}>
          <svg className={`select-none ${isListVisible ? '' : 'rotate-90'}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
